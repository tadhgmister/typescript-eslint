...
declare global {
  ...
  namespace ESLintConfig {
    ...
    export interface BaseConfig {
       ...
       */
      extends?: string[] | (keyof PluginConfigs)[];
       ...
       */
      plugins?: keyof PluginRules | (keyof PluginRules)[];
       ...
       */
      rules?: Partial<
        BaseRules & UnionToIntersection<PluginRules[keyof PluginRules]>
      >;
    ...
    interface BaseRules {}
    /**
     * record of plugin names: true for available plugins
     */
